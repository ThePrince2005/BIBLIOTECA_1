  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      items.forEach((item, index) => {
        ...
        card.innerHTML = `
          <div class="virtual-card__image-wrapper">
            <img 
              src="${image}" 
              class="virtual-card__image" 
              alt="Portada de ${info.title || 'Libro'}"
              onerror="this.src='https://via.placeholder.com/300x450/667eea/ffffff?text=Sin+Portada'"
            >
            <div class="virtual-card__badge">
              <i class="fa-solid fa-book"></i>
              Virtual
            </div>
          </div>
          <div class="virtual-card__content">
            <h3 class="virtual-card__title">${info.title || 'Sin título'}</h3>
            <p class="virtual-card__author">
              <i class="fa-solid fa-user-pen"></i>
              ${autores}
            </p>
            <p class="virtual-card__description">${descripcion}</p>
            <div class="virtual-card__meta">
              <div class="virtual-card__meta-item">
